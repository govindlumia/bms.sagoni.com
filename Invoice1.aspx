...
<body style="margin:5px 0px 0px 0px">
    ...
    <td width="225" valign="top"><asp:Label ID="lbl_address" runat="server" ></asp:Label></td>
	</tr>
    <tr>
    ...
    <tr>
    <td width="110" valign="top" bgcolor="#CECECE">Customer ID :</td>
    <td valign="top"><asp:Label ID="lblcuid" runat="server" ></asp:Label></td>
    </tr>
    ...
    <td style="border:1px solid #8C8C8C; text-align:center; width:300px"><b>Total Amount</b></td> 
    </tr>
    ...
    <td style="border:1px solid #8C8C8C; text-align:center; width:300px"><asp:Label ID="lbltotalamt" runat="server" ></asp:Label></td> 
    </tr>
   ...
   <%-- <b>Company Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> &nbsp; MKJI INFRASTRUCTURE  <br />
	...
	<tr>
    <td width="46%" align="left" bgcolor="#E1E1E1" style="border-left:2px solid #8C8C8C;border-bottom:2px solid #8C8C8C; padding-left:5px"> Grandtotal Amount :</td>
    <td width="54%"  style="border-right:2px solid #8C8C8C;border-bottom:2px solid #8C8C8C; border-left:2px solid #8C8C8C" align="center"><asp:Label ID="lbltotal" runat="server" ></asp:Label></td>
    </tr>
    <tr>
    <td width="46%" align="left" bgcolor="#E1E1E1" style="border-left:2px solid #8C8C8C;border-bottom:2px solid #8C8C8C; padding-left:5px"> Recieved Amount :</td>
    <td width="54%"  style="border-right:2px solid #8C8C8C;border-bottom:2px solid #8C8C8C; border-left:2px solid #8C8C8C" align="center"><asp:Label ID="lblrecievedamt" runat="server" ></asp:Label></td>
    </tr>
    <tr>
    <td width="46%" align="left" bgcolor="#E1E1E1" style="border-left:2px solid #8C8C8C;border-bottom:2px solid #8C8C8C; padding-left:5px"> Rest Amount(Dues) :</td>
    <td width="54%"  style="border-right:2px solid #8C8C8C;border-bottom:2px solid #8C8C8C; border-left:2px solid #8C8C8C" align="center"><asp:Label ID="lblbalanceamt" runat="server" ></asp:Label></td>
    </tr>
