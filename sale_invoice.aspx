...
<body style="margin:5px 0px 0px 0px">
    ...
    <td valign="middle" style="width:400px; text-align:left; padding-left:5px">
     <img alt="" src="images/invoice_mkji.png" width="260px" height="100px"/>
    </td>
    ...
    <tr>
    <td width="110" valign="top" bgcolor="#CECECE">Specialist :</td>
    <td width="225" valign="top"><asp:Label ID="lblspe" runat="server" ></asp:Label></td>
	</tr>
   </table>
    </td>
    ...
    <table cellspacing="0" cellpadding="4" style="float:right; width:325px; line-height:16px" border="1" bordercolor="#8C8C8C" >
     ...
     <tr>
    <td width="110" valign="top" bgcolor="#CECECE">PO Date :</td>
    <td valign="top"><asp:Label ID="lblDate" runat="server" ></asp:Label></td>
	</tr>
    
    <tr>
    <td width="110" valign="top" bgcolor="#CECECE">PO No. :</td>
    <td valign="top"><asp:Label ID="lblInvoiceNo" runat="server" ></asp:Label></td>
	</tr>
   
    <tr>
    <td width="110" valign="top" bgcolor="#CECECE">Ag.Period. :</td>
    <td valign="top"><asp:Label ID="lblagperiod" runat="server" ></asp:Label></td>
    </tr>
    ...
    <br /> 011 - 29891675 | 9990985792
       <br /> sales@doplus.in  |  www.doplus.in
