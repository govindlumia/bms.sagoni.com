<%@ Page Language="C#" AutoEventWireup="true" CodeFile="print-quotation.aspx.cs" Inherits="print_quotation" %>
...
#header_left p{
		...
		font:10px Times New Roman, Helvetica, sans-serif;
		}
#header_left h5{
...
<div id="wrapper">
    ...
    <td valign="middle" style="width:480px; text-align:right; padding-right:10px">
     <p align="right" style="font-size:10px; margin:0px;font-family:Times New Roman;text-align:right; padding-right:10px; line-height:20px">
      <strong style="font-size:15px">Website : www.sagoni.com</strong><br />
      <strong style="font-size:15px">Email : sales@sagoni.com </strong><br />
      <strong style="font-size:15px">Contact : +9<strong style="font-size:15px">-8800118712 </strong>
         +91-97172066531 </strong><br />
    ...
    <tr>
    <td  valign="middle" style="padding-bottom:5px; text-align:center; font-size:16px; padding-left:2px;padding-top:5px; background-color:#CECECE;"><b>QUOTATION</b>
    </td>
    </tr>
    ...
    <tr>
    <td valign="middle" style="text-align:left; padding-left:10px; padding-top:5px; width:50%; font-size:16px"> To </td>
    ...
    <tr>
    <td valign="middle" style="text-align:left; padding-left:10px; padding-top:5px; width:50%; font-size:16px"> <asp:Label ID="lblname" runat="server"></asp:Label>
 </td>
    ...
    <tr>
    <td valign="middle" style="text-align:left; padding-left:10px; padding-top:10px; width:50%; font-size:16px"> <asp:Label ID="lblMobile" runat="server">  </asp:Label> </td>
    <td valign="middle" style="text-align:left; padding-left:230px; padding-top:10px; width:50%"></td>
    </tr>
    <tr>
    <td valign="middle" style="text-align:left; padding-left:10px; padding-top:10px; width:50%; font-size:16px"> <asp:Label ID="lblemail" runat="server"></asp:Label> </td>
    <td valign="middle" style="text-align:left; padding-left:230px; padding-top:10px; width:50%"></td>
    </tr>

    <tr>
    <td valign="middle" style="text-align:left; padding-left:10px; padding-top:10px; width:50%; font-size:16px"> <asp:Label ID="lbl_address" runat="server"></asp:Label> </td>
    <td valign="middle" style="text-align:left; padding-left:230px; padding-top:10px; width:50%"></td>
    </tr>
    ...
    <tr>
    <td valign="top" style=" font-size:16px; padding-left:10px;">
    <b>Dear Sir / Madam</b>
    </td>
    </tr>

    <tr>
    <td valign="top" style=" font-size:16px; padding-left:10px; padding-top:5px">
    ...
    <tr>
    <td valign="middle" style="text-align:left; padding-left:10px; padding-top:5px;font-size:15px; line-height:20px"> 
    ...
    <div id="Div1" style="width:100%;border-collapse:collapse; padding-top:0px; line-height:30px; text-align:center">
  ...
  <FooterStyle BackColor="#CCCC99" HorizontalAlign="center" Font-Bold ="true" />              
   ...
   <asp:TemplateField HeaderText="Sno." HeaderStyle-ForeColor="black">
    ...
    <%-- <p style="font-family:Arial; font-size:13px; line-height:20px">
      For Credit to Bank Name : HDFC BANK LTD. <br />Address :  Mohan Co-opertive Industrial Estate,
...
New Delhi-110044<br />In favor of : " MKJI INFRASTRUCTURE "<br />Bank Account Number: 50100082456560
    ...
    <td valign="top" style=" padding-top:10px; line-height:15px; line-height:23px">
     <b style="font-size:13px">TERMS & CONDITIONS</b><br />
    <br />
