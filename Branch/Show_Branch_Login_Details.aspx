<%@ Page Title="::Sagoni India Private Limited::" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Show_Branch_Login_Details.aspx.cs" Inherits="Show_Branch_Login_Details" %>
...
<table width="100%" cellpadding="0" cellspacing="0" class="big" >
 ...
 <td valign="middle" class="dvtCellLabeltop">USER NAME : </td>
   ...
   <tr>
   <td valign="middle"  colspan="4" style=" text-align:center; background-color:#DDDCDD; height:45px; padding-top:10px">
