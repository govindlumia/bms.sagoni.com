<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Appointment_View"Culture ="en-GB" UICulture ="en-GB" %>
 ...
 <asp:GridView ID="GridView1" runat ="server" AutoGenerateColumns ="False"   GridLines ="None"  
            ...
            <asp:ImageButton ID="imgInvoice" ImageUrl ="~/images/print.png" runat="server" CommandName ="PRINT" ToolTip ="Click to Print" CausesValidation ="false"   /> 
                           ...
                           <asp:TemplateField HeaderText="sno" Visible= "false">
                                ...
                                <asp:BoundField DataField ="patient_AdmitDate" HeaderText ="Appointment Date"/>
                                <asp:BoundField DataField ="Time" HeaderText ="Appointment Time"/>  
                                 <asp:BoundField DataField ="Patient_name" HeaderText ="Patient Name"/> 
                                  <asp:BoundField DataField ="patient_age" HeaderText ="Age "/> 
                                   <asp:BoundField DataField ="patient_contact" HeaderText ="Contact "/> 
                                    <asp:BoundField DataField ="patient_Address" HeaderText ="Address "/> 
                                   <asp:BoundField DataField ="patient_Gurdian" HeaderText ="Gurdian"/> 
                                  
                                    <asp:BoundField DataField ="patient_Fee" HeaderText ="Fee "/> 
